function generateNotify(allData) {
  ...
  message = "";
  if (bullish !== "0" || !bullish) {
    message = `Buy Signal Occered \n`;
  }

  if (bullish_plus !== "0" || !bullish_plus) {
    message = `Strong Buy Signal Occered \n`;
  }

  if (bearish !== "0" || !bullish) {
    message = `Sell Signal Occered \n`;
  }

  if (bearish_plus !== "0" || !bullish_plus) {
    message = `Strong Sell Signal Occered \n`;
  }

  if (bearish_exit !== "null" || !bullish_exit) {
    message = `Sell Exit Signal Occered \n`;
  }

  if (bullish_exit !== "null" || !bullish_exit) {
    message = `Buy Exit Signal Occered \n`;
  }
